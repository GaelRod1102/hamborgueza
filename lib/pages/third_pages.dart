    ...
    return Material(
      ...
      child: SingleChildScrollView(
        ...
        Container(
          ...
          child: Text('Documentos para tramitar la licencia', textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold) //Fin TextStyle
              ),
        ), //Fin Container 3
        SizedBox(
          height: 20.0,
        ...
        InkWell(
          ...
          child: Container(padding: EdgeInsets.all(50), child: Image.asset("assets/images/licewncia.jpg")), //Fin Container 4
        ),
      ] //Fin Widget[]
              ) //Fin Column
