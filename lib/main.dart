...
import 'package:gael/pages/first_pages.dart';
import 'package:gael/pages/second_pages.dart';
import 'package:gael/pages/third_pages.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(onTap: (newIndex) => setState(() => _index = newIndex), currentIndex: _index, items: [
        ...
        BottomNavigationBarItem(
            ...
            title: Text('Login')), //
        BottomNavigationBarItem(
            icon: Icon(Icons.directions_car, color: Colors.blueAccent, size: 30.0), //icon
            title: Text('Rutas o ayuda')), //
      ]), // bottom
    ); //fin de Scaffold
  } //fin de Widget
